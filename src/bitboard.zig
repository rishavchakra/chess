...
pub const rank1: Bitboard = 0x00000000000000ff;
pub const rank2: Bitboard = 0x000000000000ff00;
pub const rank3: Bitboard = 0x0000000000ff0000;
pub const rank4: Bitboard = 0x00000000ff000000;
pub const rank5: Bitboard = 0x000000ff00000000;
pub const rank6: Bitboard = 0x0000ff0000000000;
pub const rank7: Bitboard = 0x00ff000000000000;
pub const rank8: Bitboard = 0xff00000000000000;

pub const fileA: Bitboard = 0x0101010101010101;
pub const fileB: Bitboard = 0x0202020202020202;
pub const fileC: Bitboard = 0x0404040404040404;
pub const fileD: Bitboard = 0x0808080808080808;
pub const fileE: Bitboard = 0x1010101010101010;
pub const fileF: Bitboard = 0x2020202020202020;
pub const fileG: Bitboard = 0x4040404040404040;
pub const fileH: Bitboard = 0x8080808080808080;

pub const diag0: Bitboard = 0x8040201008040201;
pub const diag1: Bitboard = 0x4020100804020100;
pub const diag2: Bitboard = 0x2010080402010000;
pub const diag3: Bitboard = 0x1008040201000000;
pub const diag4: Bitboard = 0x0804020100000000;
pub const diag5: Bitboard = 0x0402010000000000;
pub const diag6: Bitboard = 0x0201000000000000;
pub const diag7: Bitboard = 0x0100000000000000;
pub const diag8: Bitboard = 0; // DNE
pub const diag9: Bitboard = 0x0000000000000080;
pub const diag10: Bitboard = 0x0000000000008040;
pub const diag11: Bitboard = 0x0000000000804020;
pub const diag12: Bitboard = 0x0000000080402010;
pub const diag13: Bitboard = 0x0000008040201008;
pub const diag14: Bitboard = 0x0000804020100804;
pub const diag15: Bitboard = 0x0080402010080402;

pub const antidiag0: Bitboard = 0x0102040810204080;
pub const antidiag1: Bitboard = 0x0001020408102040;
pub const antidiag2: Bitboard = 0x0000010204081020;
pub const antidiag3: Bitboard = 0x0000000102040810;
pub const antidiag4: Bitboard = 0x0000000001020408;
pub const antidiag5: Bitboard = 0x0000000000010204;
pub const antidiag6: Bitboard = 0x0000000000000102;
pub const antidiag7: Bitboard = 0x0000000000000001;
pub const antidiag8: Bitboard = 0; // DNE
pub const antidiag9: Bitboard = 0x8000000000000000;
pub const antidiag10: Bitboard = 0x4080000000000000;
pub const antidiag11: Bitboard = 0x2040800000000000;
pub const antidiag12: Bitboard = 0x1020408000000000;
pub const antidiag13: Bitboard = 0x0810204080000000;
pub const antidiag14: Bitboard = 0x0408102040800000;
pub const antidiag15: Bitboard = 0x0204081020408000;
